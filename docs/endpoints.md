...
產生時間 (UTC): 2026-08-31T06:46:21.222797+00:00
...
- `/ETFReport/ETFRank`  定期定額交易戶數統計排行月報表
...
- `/exchangeReport/TWT48U_ALL`  上市股票除權除息預告表
...
- `/fund/MI_QFIIS_cat`  集中市場外資及陸資投資類股持股比率表
- `/fund/MI_QFIIS_sort_20`  集中市場外資及陸資持股前 20 名彙總表
...
- `/opendata/t187ap06_L_basi`  上市公司綜合損益表(金融業)
- `/opendata/t187ap06_L_bd`  上市公司綜合損益表(證券期貨業)
- `/opendata/t187ap06_L_ci`  上市公司綜合損益表(一般業)
- `/opendata/t187ap06_L_fh`  上市公司綜合損益表(金控業)
- `/opendata/t187ap06_L_ins`  上市公司綜合損益表(保險業)
- `/opendata/t187ap06_L_mim`  上市公司綜合損益表(異業)
- `/opendata/t187ap06_X_basi`  公發公司綜合損益表-金融業
- `/opendata/t187ap06_X_bd`  公發公司綜合損益表-證券期貨業
- `/opendata/t187ap06_X_ci`  公發公司綜合損益表-一般業
- `/opendata/t187ap06_X_fh`  公發公司綜合損益表-金控業
- `/opendata/t187ap06_X_ins`  公發公司綜合損益表-保險業
- `/opendata/t187ap06_X_mim`  公發公司綜合損益表-異業
- `/opendata/t187ap07_L_basi`  上市公司資產負債表(金融業)
- `/opendata/t187ap07_L_bd`  上市公司資產負債表(證券期貨業)
- `/opendata/t187ap07_L_ci`  上市公司資產負債表(一般業)
- `/opendata/t187ap07_L_fh`  上市公司資產負債表(金控業)
- `/opendata/t187ap07_L_ins`  上市公司資產負債表(保險業)
- `/opendata/t187ap07_L_mim`  上市公司資產負債表(異業)
- `/opendata/t187ap07_X_basi`  公發公司資產負債表-金融業
- `/opendata/t187ap07_X_bd`  公發公司資產負債表-證券期貨業
- `/opendata/t187ap07_X_ci`  公發公司資產負債表-一般業
- `/opendata/t187ap07_X_fh`  公發公司資產負債表-金控業
- `/opendata/t187ap07_X_ins`  公發公司資產負債表-保險業
- `/opendata/t187ap07_X_mim`  公發公司資產負債表-異業
- `/opendata/t187ap08_L`  上市公司董事、監察人持股不足法定成數彙總表
- `/opendata/t187ap09_L`  上市公司董事、監察人質權設定占董事及監察人實際持有股數彙總表
- `/opendata/t187ap10_L`  上市公司董事、監察人持股不足法定成數連續達3個月以上彙總表
- `/opendata/t187ap11_L`  上市公司董監事持股餘額明細資料
- `/opendata/t187ap11_P`  公發公司董監事持股餘額明細
- `/opendata/t187ap12_L`  上市公司每日內部人持股轉讓事前申報表-持股轉讓日報表
- `/opendata/t187ap13_L`  上市公司每日內部人持股轉讓事前申報表-持股未轉讓日報表
- `/opendata/t187ap14_L`  上市公司各產業EPS統計資訊
- `/opendata/t187ap15_L`  上市公司截至各季綜合損益財測達成情形(簡式)
- `/opendata/t187ap16_L`  上市公司當季綜合損益經會計師查核(核閱)數與當季預測數差異達百分之十以上者，或截至當季累計差異達百分之二十以上者(簡式)
- `/opendata/t187ap17_L`  上市公司營益分析查詢彙總表(全體公司彙總報表)
...
- `/opendata/t187ap24_L`  上市公司經營權及營業範圍異(變)動專區-經營權異動公司
- `/opendata/t187ap25_L`  上市公司經營權及營業範圍異(變)動專區-營業範圍重大變更公司
- `/opendata/t187ap26_L`  上市公司經營權及營業範圍異(變)動專區-經營權異動且營業範圍重大變更停止買賣公司
- `/opendata/t187ap27_L`  上市公司經營權及營業範圍異(變)動專區-經營權異動且營業範圍重大變更列為變更交易公司
- `/opendata/t187ap29_A_L`  上市公司董事酬金相關資訊
- `/opendata/t187ap29_B_L`  上市公司監察人酬金相關資訊
- `/opendata/t187ap29_C_L`  上市公司合併報表董事酬金相關資訊
- `/opendata/t187ap29_D_L`  上市公司合併報表監察人酬金相關資訊
- `/opendata/t187ap30_L`  上市公司獨立董監事兼任情形彙總表
- `/opendata/t187ap31_L`  上市公司財務報告經監察人承認情形
- `/opendata/t187ap32_L`  上市公司公司治理之相關規程規則
- `/opendata/t187ap33_L`  上市公司董事長是否兼任總經理
- `/opendata/t187ap34_L`  上市公司採累積投票制、全額連記法、候選人提名制選任董監事及當選資料彙總表
- `/opendata/t187ap35_L`  上市公司股東行使提案權情形彙總表
- `/opendata/t187ap36_L`  上市認購(售)權證年度發行量概況統計表
- `/opendata/t187ap37_L`  上市權證基本資料彙總表
- `/opendata/t187ap38_L`  上市公司股東會公告-召集股東常(臨時)會公告資料彙總表(95年度起適用)
- `/opendata/t187ap41_L`  上市公司召開股東常 (臨時) 會日期、地點及採用電子投票情形等資料彙總表
- `/opendata/t187ap42_L`  上市認購(售)權證每日成交資料檔
- `/opendata/t187ap43_L`  上市認購(售)權證交易人數檔
- `/opendata/t187ap45_L`  上市公司股利分派情形
- `/opendata/t187ap46_L_1`  上市公司企業ESG資訊揭露彙總資料-溫室氣體排放
- `/opendata/t187ap46_L_10`  上市公司企業ESG資訊揭露彙總資料-燃料管理
- `/opendata/t187ap46_L_11`  上市公司企業ESG資訊揭露彙總資料-產品生命週期
- `/opendata/t187ap46_L_12`  上市公司企業ESG資訊揭露彙總資料-食品安全
- `/opendata/t187ap46_L_13`  上市公司企業ESG資訊揭露彙總資料-供應鏈管理
- `/opendata/t187ap46_L_14`  上市公司企業ESG資訊揭露彙總資料-產品品質與安全
- `/opendata/t187ap46_L_15`  上市公司企業ESG資訊揭露彙總資料-社區關係
- `/opendata/t187ap46_L_16`  上市公司企業ESG資訊揭露彙總資料-資訊安全
- `/opendata/t187ap46_L_17`  上市公司企業ESG資訊揭露彙總資料-普惠金融
- `/opendata/t187ap46_L_18`  上市公司企業ESG資訊揭露彙總資料-持股及控制力
- `/opendata/t187ap46_L_19`  上市公司企業ESG資訊揭露彙總資料-風險管理政策
- `/opendata/t187ap46_L_2`  上市公司企業ESG資訊揭露彙總資料-能源管理
- `/opendata/t187ap46_L_20`  上市公司企業ESG資訊揭露彙總資料-反競爭行為法律訴訟
- `/opendata/t187ap46_L_21`  上市公司企業ESG資訊揭露彙總資料-職業安全衛生
- `/opendata/t187ap46_L_3`  上市公司企業ESG資訊揭露彙總資料-水資源管理
- `/opendata/t187ap46_L_4`  上市公司企業ESG資訊揭露彙總資料-廢棄物管理
- `/opendata/t187ap46_L_5`  上市公司企業ESG資訊揭露彙總資料-人力發展
- `/opendata/t187ap46_L_6`  上市公司企業ESG資訊揭露彙總資料-董事會
- `/opendata/t187ap46_L_7`  上市公司企業ESG資訊揭露彙總資料-投資人溝通
- `/opendata/t187ap46_L_8`  上市公司企業ESG資訊揭露彙總資料-氣候相關議題管理
- `/opendata/t187ap46_L_9`  上市公司企業ESG資訊揭露彙總資料-功能性委員會
